...
nasm -f elf -o gdtAsm.o  kernel/src/CPU/GDT.s
...
/usr/local/cross/bin/i586-elf-gcc $CFlags -o gdt.o     -c   kernel/src/CPU/GDT.c
/usr/local/cross/bin/i586-elf-gcc $CFlags -o idt.o     -c   kernel/src/CPU/IDT.c
